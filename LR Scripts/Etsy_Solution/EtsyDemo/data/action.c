Action()
{
	...
	web_url("suggestions_ajax.php_3", 
		"URL=https://www.etsy.com/suggestions_ajax.php?extras=%7B%26quot%3Bexpt%26quot%3B%3A%26quot%3Boff%26quot%3B%2C%26quot%3Blang%26quot%3B%3A%26quot%3Ben-GB%26quot%3B%2C%26quot%3Bextras%26quot%3B%3A%5B%5D%7D&version=10_12672349415_19&search_query=jewe&search_type=all&pathname=%2F", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=https://www.etsy.com/", 
	...
	web_url("suggestions_ajax.php_4", 
		"URL=https://www.etsy.com/suggestions_ajax.php?extras=%7B%26quot%3Bexpt%26quot%3B%3A%26quot%3Boff%26quot%3B%2C%26quot%3Blang%26quot%3B%3A%26quot%3Ben-GB%26quot%3B%2C%26quot%3Bextras%26quot%3B%3A%5B%5D%7D&version=10_12672349415_19&search_query=jewell&search_type=all&pathname=%2F", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=https://www.etsy.com/", 
	...
	web_url("suggestions_ajax.php_6", 
		"URL=https://www.etsy.com/suggestions_ajax.php?extras=%7B%26quot%3Bexpt%26quot%3B%3A%26quot%3Boff%26quot%3B%2C%26quot%3Blang%26quot%3B%3A%26quot%3Ben-GB%26quot%3B%2C%26quot%3Bextras%26quot%3B%3A%5B%5D%7D&version=10_12672349415_19&search_query=jeweller&search_type=all&pathname=%2F", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=https://www.etsy.com/", 
	...
	web_custom_request("statsd", 
		"URL=https://www.etsy.com/api/v3/ajax/public/statsd", 
		"Method=POST", 
		"TargetFrame=", 
		"Resource=0", 
		...
		"Mode=HTML", 
		"EncType=text/plain;charset=UTF-8", 
		"Body={\"stats\":[{\"method\":\"increment\",\"stats\":\"search2.suggest.refactor.show.autosuggest_pane\",\"sampledRate\":0.1}],\"_nnc\":\"3:1707730910:YWTpCxXVdWn7kx06DIsmatwlZFGC:8842f05b40986c285c9bfa94d494e72213efd2dc9caf019d698eb286667f5029\"}", 
		LAST);

	web_url("suggestions_ajax.php_7", 
		"URL=https://www.etsy.com/suggestions_ajax.php?extras=%7B%26quot%3Bexpt%26quot%3B%3A%26quot%3Boff%26quot%3B%2C%26quot%3Blang%26quot%3B%3A%26quot%3Ben-GB%26quot%3B%2C%26quot%3Bextras%26quot%3B%3A%5B%5D%7D&version=10_12672349415_19&search_query=jewellery&search_type=all&pathname=%2F", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=https://www.etsy.com/", 
	...
	web_submit_data("search_async_recs", 
		"Action=https://www.etsy.com/api/v3/ajax/bespoke/member/neu/specs/search_async_recs", 
		"Method=POST", 
		"TargetFrame=", 
		"RecContentType=application/json", 
		"Referer=https://www.etsy.com/in-en/search?q=Jewellery&ref=search_bar", 
		...
		"Mode=HTML", 
		ITEMDATA, 
		"Name=log_performance_metrics", "Value=true", ENDITEM, 
		"Name=specs[spec1][]", "Value=Search2_ApiSpecs_RecentlyViewed", ENDITEM, 
		"Name=specs[spec1][1][is_mobile]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][currency_code]", "Value=INR", ENDITEM, 
		"Name=specs[spec1][1][options_array][img_size]", "Value=340x270", ENDITEM, 
		"Name=specs[spec1][1][options_array][img_sizeunit]", "Value=vw", ENDITEM, 
		"Name=specs[spec1][1][options_array][explicity_set_srcset_as_retina]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][img_placeholder_shape]", "Value=landscape", ENDITEM, 
		"Name=specs[spec1][1][options_array][img_hide_bottom_margin]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][img_is_responsively_large_square]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][is_large_ad]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][additional_img_class]", "Value=", ENDITEM, 
		"Name=specs[spec1][1][options_array][price_class]", "Value=wt-text-title-01 lc-price", ENDITEM, 
		"Name=specs[spec1][1][options_array][additional_img_placeholder_class]", "Value=", ENDITEM, 
		"Name=specs[spec1][1][options_array][additional_img_landscape_placeholder_class]", "Value=", ENDITEM, 
		"Name=specs[spec1][1][options_array][additional_listing_info_classes]", "Value=", ENDITEM, 
		"Name=specs[spec1][1][options_array][additional_listing_card_classes]", "Value=", ENDITEM, 
		"Name=specs[spec1][1][options_array][fit_to_variable_height]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][should_put_price_in_badge]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][always_visible_price_badge]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][hide_price_badge_md_down]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][use_small_price_badge]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][use_priority_badge]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][hide_percent_discount_in_small_badge]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][include_icon_in_bestseller_badge]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][img_responsive]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][img_responsive_aspect_ratio]", "Value=", ENDITEM, 
		"Name=specs[spec1][1][options_array][img_responsive_style]", "Value=", ENDITEM, 
		"Name=specs[spec1][1][options_array][img_responsive_fit]", "Value=none", ENDITEM, 
		"Name=specs[spec1][1][options_array][is_enhanced_moments_page]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][add_image_shadow_on_hover]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][suppress]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][from_search]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][lazy_load]", "Value=true", ENDITEM, 
		"Name=specs[spec1][1][options_array][hearts][user]", "Value=", ENDITEM, 
		"Name=specs[spec1][1][options_array][hearts][source]", "Value=Search2_ApiSpecs_RecentlyViewed", ENDITEM, 
		"Name=specs[spec1][1][options_array][hide_favorite_heart]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][vat_region]", "Value=IN", ENDITEM, 
		"Name=specs[spec1][1][options_array][hide_rating]", "Value=true", ENDITEM, 
		"Name=specs[spec1][1][options_array][hide_price]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][hide_bestseller]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][hide_etsys_pick]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][badges_disabled]", "Value=true", ENDITEM, 
		"Name=specs[spec1][1][options_array][hide_all_badges]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][use_collage_reviews]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][rating_count_abbreviated]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][show_micro_data]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][stash_eligibility][in_stash_already]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][stash_eligibility][stage_listings]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][stash_eligibility][view_add_listings_overlay_on_etsy]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][stash_eligibility][approve_library_listings]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][stash_eligibility][edit_tags]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][stash_eligibility][add_shop_listings_to_library]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][stash_eligibility][stage_shop_listings]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][stash_eligibility][manage_trusted_shops]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][listing_card_promotion_tooltip_top]", "Value=true", ENDITEM, 
		"Name=specs[spec1][1][options_array][hide_scarcity]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][use_order_soon_scarcity_message]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][hide_free_shipping]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][hide_free_shipping_with_minimum]", "Value=true", ENDITEM, 
		"Name=specs[spec1][1][options_array][hide_buyer_promise_conditional_free_shipping]", "Value=true", ENDITEM, 
		"Name=specs[spec1][1][options_array][inline_free_shipping]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][can_stack_signals_with_free_shipping]", "Value=true", ENDITEM, 
		"Name=specs[spec1][1][options_array][hide_discount]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][hide_discount_with_minimum]", "Value=true", ENDITEM, 
		"Name=specs[spec1][1][options_array][discount_with_minimum_promotion_has_popover]", "Value=true", ENDITEM, 
		"Name=specs[spec1][1][options_array][hide_listing_title]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][hide_shop_name]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][hide_shop_name_bottom_margin]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][hide_bottom_margin]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][show_shop_location]", "Value=true", ENDITEM, 
		"Name=specs[spec1][1][options_array][hide_more_colors]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][use_updated_more_colors_badge]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][use_round_more_colors_badge]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][open_add_to_list_modal_on_favoriting]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][is_market_page]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][wrap_discount_price]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][show_simple_discount_in_badge]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][simple_discount_in_badge_slime]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][strikethrough_price_normal]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][show_fulfilled_registry_listing_status]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][show_unavailable_registry_listing_status]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][show_registry_edit_button]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][show_add_to_registry_button]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][show_add_to_registry_cta]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][show_add_icon_on_registry_cta]", "Value=true", ENDITEM, 
		"Name=specs[spec1][1][options_array][registry_key]", "Value=", ENDITEM, 
		"Name=specs[spec1][1][options_array][registry_source]", "Value=", ENDITEM, 
		"Name=specs[spec1][1][options_array][show_registry_customization_buttons]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][show_select_registry_listing_button]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][show_pricing_variations_indicator_registry_listings]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][move_shop_name_below_price]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][use_small_text_for_ratings_count]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][badge_ranking]", "Value=DEFAULT_RANKING", ENDITEM, 
		"Name=specs[spec1][1][options_array][refine_by_listing]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][use_listing_title_for_mlt]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][is_favorited]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][is_in_list]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][show_quickview]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][show_quickshop_hover]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][show_quickshop_replace_atc]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][remove_atc_top_margin]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][set_flex_basis_to_auto]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][show_variations_signal]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][discount_is_signal]", "Value=true", ENDITEM, 
		"Name=specs[spec1][1][options_array][query]", "Value=Jewellery", ENDITEM, 
		"Name=specs[spec1][1][options_array][is_block_grid_item]", "Value=true", ENDITEM, 
		"Name=specs[spec1][1][options_array][is_collage_block_grid_item]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][grid_item_xs_size]", "Value=6", ENDITEM, 
		"Name=specs[spec1][1][options_array][grid_item_lg_size]", "Value=2", ENDITEM, 
		"Name=specs[spec1][1][options_array][grid_item_md_size]", "Value=4", ENDITEM, 
		"Name=specs[spec1][1][options_array][grid_item_xl_size]", "Value=2", ENDITEM, 
		"Name=specs[spec1][1][options_array][is_collage_card_group_item]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][flex_shrink_xs_value]", "Value=1", ENDITEM, 
		"Name=specs[spec1][1][options_array][margin_right_xs_value]", "Value=0", ENDITEM, 
		"Name=specs[spec1][1][options_array][is_side_scrolling]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][is_transparent_card]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][is_block_grid_item_transparent_card]", "Value=true", ENDITEM, 
		"Name=specs[spec1][1][options_array][is_anchored_listing_updates_experiment]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][use_ad_by_etsy_seller_label]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][show_ad_badge_in_ranked_badges]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][show_first_in_bundle_badge]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][show_img_and_info_in_grid]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][is_clickable]", "Value=true", ENDITEM, 
		"Name=specs[spec1][1][options_array][should_link_to_similar]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][should_show_new_similar_page]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][show_flex_none]", "Value=true", ENDITEM, 
		"Name=specs[spec1][1][options_array][should_toolkit_v2_be_list_item]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][show_purchase_date]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][nudge_card_info]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][in_recently_viewed]", "Value=true", ENDITEM, 
		"Name=specs[spec1][1][options_array][no_gutter_images]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][show_favorites_count]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][show_popular_now_badge]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][can_show_star_seller_badge]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][can_show_shop_name_star_seller_badge_flag]", "Value=ranking/search.experience.star_seller_search_module_recently_viewed_badge", ENDITEM, 
		"Name=specs[spec1][1][options_array][show_market_star_seller_badge]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][show_shop_name_star_seller_badge]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][force_star_seller_listing_signal]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][can_show_market_star_seller_border]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][show_market_star_seller_border]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][force_star_seller_border_signal]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][card_outline]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][show_video]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][show_collage_video_preview]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][is_anchor_listing_market_category_ingress_updates]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][use_you_save_variant]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][title_classes]", "Value=", ENDITEM, 
		"Name=specs[spec1][1][options_array][title_tag]", "Value=h3", ENDITEM, 
		"Name=specs[spec1][1][options_array][include_shop_id_for_ads]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][show_add_to_cart]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][eligible_for_atc_on_all_listings]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][should_open_edit_panel_for_atc]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][hide_free_shipping_below_price]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][show_discount_with_free_shipping]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][sale_price_text_class]", "Value=wt-text-slime", ENDITEM, 
		"Name=specs[spec1][1][options_array][small_bottom_margin]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][show_sale_ends_in_signal]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][hide_percent_discount]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][show_red_discounted_price]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][show_green_discounted_price]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][use_larger_review_stars]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][is_eligible_for_single_review_star]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][move_shop_name_with_rating]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][show_free_shipping_text]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][is_listing_from_favorited_shop]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][include_shop_icon_ad_badge]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][include_shaded_ad_badge]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][show_shop_name_heart]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][increase_threshold_popular_now]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][reduce_sale_countdown_coverage]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][should_final_price_be_green]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][decode_listing_card_image_synchronous]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][show_category_link]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][use_dynamic_css_to_label_ads]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][do_not_render_plkey_atc_form]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][category_link_url]", "Value=", ENDITEM, 
		"Name=specs[spec1][1][options_array][category_link_title]", "Value=", ENDITEM, 
		"Name=specs[spec1][1][options_array][category_link_ref_tag]", "Value=", ENDITEM, 
		"Name=specs[spec1][1][options_array][is_desktop_style_for_badge_in_image]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][should_use_large_ad_position_for_badge_in_image]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][is_eligible_for_streamline_pricing_info]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][streamline_pricing_info_narrowing_module]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][minimal_listing_card_title_class_overrides]", "Value=", ENDITEM, 
		"Name=specs[spec1][1][options_array][minimal_listing_card_price_class_overrides]", "Value=", ENDITEM, 
		"Name=specs[spec1][1][options_array][is_eligible_for_streamline_seller_info]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][should_open_same_tab]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][display_as_flashlight_ad]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][include_css_id_selector]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][hide_image]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][should_use_multi_line_title]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][slideshow_on_hover]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][change_title_attribute_placement]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][eligible_for_digital_signal_search]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][eligible_for_digital_signal_market_category]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][should_show_add_to_cart_flyout]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][use_alternate_plkey_param_name_on_add_to_cart]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][streamline_info_for_minimal_listing_card]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][is_styled_listing_image]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][should_show_mweb_image_and_video_carousel]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][should_show_mweb_video_only_carousel]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][eligible_for_minimize_mweb_lc_height]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][eligible_display_color_size_variations]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][bold_listing_card_title_with_variations_displayed]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][force_display_only_one_variation]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][should_preload_lp_img]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][is_eligible_for_video_optimizations]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][use_seo_optimized_card_links]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][eligible_for_updated_pricing_elements]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][eligible_for_updated_non_pricing_elements]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][move_price_and_free_shipping_to_top]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][options_array][add_margin_bottom_for_differentiate_lc_rows]", "Value=false", ENDITEM, 
		"Name=specs[spec1][1][has_personalization_consent]", "Value=true", ENDITEM, 
		"Name=specs[spec2][]", "Value=Search2_ApiSpecs_SimilarToRecentlyViewedListings", ENDITEM, 
		"Name=specs[spec2][1][is_mobile]", "Value=false", ENDITEM, 
		"Name=specs[spec2][1][has_personalization_consent]", "Value=true", ENDITEM, 
		"Name=specs[spec2][1][is_search_page]", "Value=true", ENDITEM, 
		"Name=specs[spec2][1][page_number]", "Value=1", ENDITEM, 
		LAST);
	...
	web_submit_data("search_async_narrowing_modules", 
		"Action=https://www.etsy.com/api/v3/ajax/bespoke/member/neu/specs/search_async_narrowing_modules", 
		"Method=POST", 
		"TargetFrame=", 
		"RecContentType=application/json", 
		"Referer=https://www.etsy.com/in-en/search?q=Jewellery&ref=search_bar", 
		...
		ITEMDATA, 
		"Name=log_performance_metrics", "Value=true", ENDITEM, 
		"Name=specs[spec4][]", "Value=Search2_ApiSpecs_NarrowingIntentModules_ListingCardRow", ENDITEM, 
		"Name=specs[spec4][1][params][detected_locale][language]", "Value=en-GB", ENDITEM, 
		"Name=specs[spec4][1][params][detected_locale][currency_code]", "Value=INR", ENDITEM, 
		"Name=specs[spec4][1][params][detected_locale][region]", "Value=IN", ENDITEM, 
		"Name=specs[spec4][1][params][locale][language]", "Value=en-GB", ENDITEM, 
		"Name=specs[spec4][1][params][locale][currency_code]", "Value=INR", ENDITEM, 
		"Name=specs[spec4][1][params][locale][region]", "Value=IN", ENDITEM, 
		"Name=specs[spec4][1][params][name_map][query]", "Value=q", ENDITEM, 
		"Name=specs[spec4][1][params][name_map][query_type]", "Value=qt", ENDITEM, 
		"Name=specs[spec4][1][params][name_map][results_per_page]", "Value=result_count", ENDITEM, 
		"Name=specs[spec4][1][params][name_map][min_price]", "Value=min", ENDITEM, 
		"Name=specs[spec4][1][params][name_map][max_price]", "Value=max", ENDITEM, 
		"Name=specs[spec4][1][params][parameters][q]", "Value=Jewellery", ENDITEM, 
		"Name=specs[spec4][1][params][parameters][ref]", "Value=search_bar", ENDITEM, 
		"Name=specs[spec4][1][params][parameters][utm_medium]", "Value=", ENDITEM, 
		"Name=specs[spec4][1][params][parameters][utm_source]", "Value=", ENDITEM, 
		"Name=specs[spec4][1][params][parameters][placement]", "Value=wsg", ENDITEM, 
		"Name=specs[spec4][1][params][parameters][page_type]", "Value=search", ENDITEM, 
		"Name=specs[spec4][1][params][parameters][result_count]", "Value=48", ENDITEM, 
		"Name=specs[spec4][1][params][parameters][request_type]", "Value=initial", ENDITEM, 
		"Name=specs[spec4][1][params][parameters][referrer]", "Value=", ENDITEM, 
		"Name=specs[spec4][1][params][parameters][bucket_id]", "Value=uglmAfXTy3lWTl37jMSr_19FNNlD", ENDITEM, 
		"Name=specs[spec4][1][params][parameters][user_id]", "Value=", ENDITEM, 
		"Name=specs[spec4][1][params][parameters][filter_distracting_content]", "Value=true", ENDITEM, 
		"Name=specs[spec4][1][params][parameters][spell_correction_via_mmx]", "Value=true", ENDITEM, 
		"Name=specs[spec4][1][params][parameters][should_pass_user_location_to_thrift]", "Value=true", ENDITEM, 
		"Name=specs[spec4][1][params][user_id]", "Value=", ENDITEM, 
		"Name=specs[spec4][1][listing_ids][]", "Value=1514410368", ENDITEM, 
		"Name=specs[spec4][1][listing_ids][]", "Value=1053942963", ENDITEM, 
		"Name=specs[spec4][1][listing_ids][]", "Value=1256931442", ENDITEM, 
		"Name=specs[spec4][1][listing_ids][]", "Value=236815596", ENDITEM, 
		"Name=specs[spec4][1][listing_ids][]", "Value=610288160", ENDITEM, 
		"Name=specs[spec4][1][listing_ids][]", "Value=1524950143", ENDITEM, 
		"Name=specs[spec4][1][listing_card_ref]", "Value=search2_top_narrowing_intent_modules_etsys_pick", ENDITEM, 
		"Name=specs[spec4][1][view_options][link_url]", "Value=https://www.etsy.com/search?q=Jewellery&ref=s2_epnsm&explicit=1&is_merch_library=true", ENDITEM, 
		"Name=specs[spec4][1][view_options][listing_card_ref]", "Value=search2_top_narrowing_intent_modules_etsys_pick", ENDITEM, 
		"Name=specs[spec4][1][view_options][placeholder_cards_count]", "Value=6", ENDITEM, 
		"Name=specs[spec4][1][view_options][view_template]", "Value=", ENDITEM, 
		"Name=specs[spec4][1][view_options][outer_div_classes]", "Value=wt-pl-xs-3 wt-pr-xs-3 wt-mt-xs-2 wt-mb-xs-2 wt-bb-xs wt-mt-xs-4", ENDITEM, 
		LAST);
	...
	web_submit_data("from-cached-data", 
		"Action=https://www.etsy.com/api/v3/ajax/bespoke/public/neu/specs/from-cached-data?q=Jewellery&ref=search_bar", 
		"Method=POST", 
		"TargetFrame=", 
		"RecContentType=application/json", 
		"Referer=https://www.etsy.com/in-en/search?q=Jewellery&ref=search_bar", 
		...
		"Mode=HTML", 
		ITEMDATA, 
		"Name=spec_name", "Value=Search2_ApiSpecs_Filters_Parent", ENDITEM, 
		"Name=cache_key", "Value=d0fe2210abdd2cb49e85fd75d920771b5fdd18057debc24df04139cfb61a408a", ENDITEM, 
		"Name=view_data_event_name", "Value=search_lazy_filters_specview_rendered", ENDITEM, 
		LAST);
	...
	web_submit_data("listingCards", 
		"Action=https://www.etsy.com/api/v3/ajax/bespoke/member/neu/specs/listingCards", 
		"Method=POST", 
		"TargetFrame=", 
		"RecContentType=application/json", 
		"Referer=https://www.etsy.com/in-en/search?q=Jewellery&ref=search_bar", 
		...
		ITEMDATA, 
		"Name=log_performance_metrics", "Value=true", ENDITEM, 
		"Name=specs[listingCards][]", "Value=Search2_ApiSpecs_LazyListingCards", ENDITEM, 
		"Name=specs[listingCards][1][listing_ids][]", "Value=1510052713", ENDITEM, 
		"Name=specs[listingCards][1][listing_ids][]", "Value=1319575237", ENDITEM, 
		"Name=specs[listingCards][1][listing_ids][]", "Value=1388107216", ENDITEM, 
		"Name=specs[listingCards][1][listing_ids][]", "Value=719835243", ENDITEM, 
		"Name=specs[listingCards][1][listing_ids][]", "Value=1065614326", ENDITEM, 
		"Name=specs[listingCards][1][listing_ids][]", "Value=1402358054", ENDITEM, 
		"Name=specs[listingCards][1][listing_ids][]", "Value=1540768527", ENDITEM, 
		"Name=specs[listingCards][1][listing_ids][]", "Value=1415811682", ENDITEM, 
		"Name=specs[listingCards][1][listing_ids][]", "Value=982748551", ENDITEM, 
		"Name=specs[listingCards][1][listing_ids][]", "Value=1135350726", ENDITEM, 
		"Name=specs[listingCards][1][listing_ids][]", "Value=1499162545", ENDITEM, 
		"Name=specs[listingCards][1][listing_ids][]", "Value=1500428364", ENDITEM, 
		"Name=specs[listingCards][1][listing_ids][]", "Value=996485176", ENDITEM, 
		"Name=specs[listingCards][1][listing_ids][]", "Value=836555100", ENDITEM, 
		"Name=specs[listingCards][1][listing_ids][]", "Value=1534917298", ENDITEM, 
		"Name=specs[listingCards][1][listing_ids][]", "Value=1346563449", ENDITEM, 
		"Name=specs[listingCards][1][listing_ids][]", "Value=1305859941", ENDITEM, 
		"Name=specs[listingCards][1][listing_ids][]", "Value=1300335494", ENDITEM, 
		"Name=specs[listingCards][1][listing_ids][]", "Value=1061934654", ENDITEM, 
		"Name=specs[listingCards][1][listing_ids][]", "Value=1639711618", ENDITEM, 
		"Name=specs[listingCards][1][listing_ids][]", "Value=1334013662", ENDITEM, 
		"Name=specs[listingCards][1][listing_ids][]", "Value=1273336965", ENDITEM, 
		"Name=specs[listingCards][1][listing_ids][]", "Value=1367523723", ENDITEM, 
		"Name=specs[listingCards][1][listing_ids][]", "Value=1213537035", ENDITEM, 
		"Name=specs[listingCards][1][listing_ids][]", "Value=1421832683", ENDITEM, 
		"Name=specs[listingCards][1][listing_ids][]", "Value=1514410368", ENDITEM, 
		"Name=specs[listingCards][1][listing_ids][]", "Value=1077098850", ENDITEM, 
		"Name=specs[listingCards][1][listing_ids][]", "Value=1169795705", ENDITEM, 
		"Name=specs[listingCards][1][listing_ids][]", "Value=1496513512", ENDITEM, 
		"Name=specs[listingCards][1][listing_ids][]", "Value=1378927045", ENDITEM, 
		"Name=specs[listingCards][1][listing_ids][]", "Value=1445607684", ENDITEM, 
		"Name=specs[listingCards][1][listing_ids][]", "Value=1343529382", ENDITEM, 
		"Name=specs[listingCards][1][listing_ids][]", "Value=1378475753", ENDITEM, 
		"Name=specs[listingCards][1][listing_ids][]", "Value=1580687622", ENDITEM, 
		"Name=specs[listingCards][1][listing_ids][]", "Value=738846052", ENDITEM, 
		"Name=specs[listingCards][1][listing_ids][]", "Value=1575274281", ENDITEM, 
		"Name=specs[listingCards][1][listing_ids][]", "Value=1331832735", ENDITEM, 
		"Name=specs[listingCards][1][listing_ids][]", "Value=1208176082", ENDITEM, 
		"Name=specs[listingCards][1][listing_ids][]", "Value=1189836338", ENDITEM, 
		"Name=specs[listingCards][1][listing_ids][]", "Value=1568688467", ENDITEM, 
		"Name=specs[listingCards][1][ad_ids][]", "Value=1136523883", ENDITEM, 
		"Name=specs[listingCards][1][ad_ids][]", "Value=1498872694", ENDITEM, 
		"Name=specs[listingCards][1][ad_ids][]", "Value=1531500588", ENDITEM, 
		"Name=specs[listingCards][1][ad_ids][]", "Value=205456347", ENDITEM, 
		"Name=specs[listingCards][1][ad_ids][]", "Value=1661791971", ENDITEM, 
		"Name=specs[listingCards][1][ad_ids][]", "Value=1618665555", ENDITEM, 
		"Name=specs[listingCards][1][ad_ids][]", "Value=1208868012", ENDITEM, 
		"Name=specs[listingCards][1][ad_ids][]", "Value=491177502", ENDITEM, 
		"Name=specs[listingCards][1][ad_ids][]", "Value=258539144", ENDITEM, 
		"Name=specs[listingCards][1][ad_ids][]", "Value=1649627240", ENDITEM, 
		"Name=specs[listingCards][1][ad_ids][]", "Value=1643006331", ENDITEM, 
		"Name=specs[listingCards][1][ad_ids][]", "Value=1568140564", ENDITEM, 
		"Name=specs[listingCards][1][logging_keys][]", "Value=5d936eace3a5b9c3c1cb7d11d2782c9f5d500887:1136523883", ENDITEM, 
		"Name=specs[listingCards][1][logging_keys][]", "Value=0a2592a34e5955497ad697e1076d90e4b4547afd:1498872694", ENDITEM, 
		"Name=specs[listingCards][1][logging_keys][]", "Value=b7ed9fb1d997de761bb4b9ad9be974e4237ee058:1531500588", ENDITEM, 
		"Name=specs[listingCards][1][logging_keys][]", "Value=1306dcd39437bc0668277368cdccae6968eb19b1:205456347", ENDITEM, 
		"Name=specs[listingCards][1][logging_keys][]", "Value=52d8d29ba1eb3a16e4b1df61a2e5fbdad794b58c:1661791971", ENDITEM, 
		"Name=specs[listingCards][1][logging_keys][]", "Value=3f6ccbce4b64f81b8d38f98db56c830f93277df1:1618665555", ENDITEM, 
		"Name=specs[listingCards][1][logging_keys][]", "Value=515f366e59310f8f7b1bd612a6dfac59c36591fd:1208868012", ENDITEM, 
		"Name=specs[listingCards][1][logging_keys][]", "Value=79dc05b7b29ffd3ba2f677f684f89444016c10e1:491177502", ENDITEM, 
		"Name=specs[listingCards][1][logging_keys][]", "Value=cbdaaf0f1a135ba21653eaac7f543b13c6840b6a:258539144", ENDITEM, 
		"Name=specs[listingCards][1][logging_keys][]", "Value=357837a6f5655ab0ae1b899f08dec6697d381569:1649627240", ENDITEM, 
		"Name=specs[listingCards][1][logging_keys][]", "Value=17cf205e9148017ebef3a022fdad75bc9ac9b9c8:1643006331", ENDITEM, 
		"Name=specs[listingCards][1][logging_keys][]", "Value=9d7a53b58e52739bcca10dd0a7922668fe20ff93:1568140564", ENDITEM, 
		"Name=specs[listingCards][1][search_request_params][detected_locale][language]", "Value=en-GB", ENDITEM, 
		"Name=specs[listingCards][1][search_request_params][detected_locale][currency_code]", "Value=INR", ENDITEM, 
		"Name=specs[listingCards][1][search_request_params][detected_locale][region]", "Value=IN", ENDITEM, 
		"Name=specs[listingCards][1][search_request_params][locale][language]", "Value=en-GB", ENDITEM, 
		"Name=specs[listingCards][1][search_request_params][locale][currency_code]", "Value=INR", ENDITEM, 
		"Name=specs[listingCards][1][search_request_params][locale][region]", "Value=IN", ENDITEM, 
		"Name=specs[listingCards][1][search_request_params][name_map][query]", "Value=q", ENDITEM, 
		"Name=specs[listingCards][1][search_request_params][name_map][query_type]", "Value=qt", ENDITEM, 
		"Name=specs[listingCards][1][search_request_params][name_map][results_per_page]", "Value=result_count", ENDITEM, 
		"Name=specs[listingCards][1][search_request_params][name_map][min_price]", "Value=min", ENDITEM, 
		"Name=specs[listingCards][1][search_request_params][name_map][max_price]", "Value=max", ENDITEM, 
		"Name=specs[listingCards][1][search_request_params][parameters][q]", "Value=Jewellery", ENDITEM, 
		"Name=specs[listingCards][1][search_request_params][parameters][ref]", "Value=search_bar", ENDITEM, 
		"Name=specs[listingCards][1][search_request_params][parameters][utm_medium]", "Value=", ENDITEM, 
		"Name=specs[listingCards][1][search_request_params][parameters][utm_source]", "Value=", ENDITEM, 
		"Name=specs[listingCards][1][search_request_params][parameters][placement]", "Value=wsg", ENDITEM, 
		"Name=specs[listingCards][1][search_request_params][parameters][page_type]", "Value=search", ENDITEM, 
		"Name=specs[listingCards][1][search_request_params][parameters][result_count]", "Value=48", ENDITEM, 
		"Name=specs[listingCards][1][search_request_params][parameters][request_type]", "Value=initial", ENDITEM, 
		"Name=specs[listingCards][1][search_request_params][parameters][referrer]", "Value=", ENDITEM, 
		"Name=specs[listingCards][1][search_request_params][parameters][bucket_id]", "Value=uglmAfXTy3lWTl37jMSr_19FNNlD", ENDITEM, 
		"Name=specs[listingCards][1][search_request_params][parameters][user_id]", "Value=", ENDITEM, 
		"Name=specs[listingCards][1][search_request_params][parameters][filter_distracting_content]", "Value=true", ENDITEM, 
		"Name=specs[listingCards][1][search_request_params][parameters][spell_correction_via_mmx]", "Value=true", ENDITEM, 
		"Name=specs[listingCards][1][search_request_params][parameters][should_pass_user_location_to_thrift]", "Value=true", ENDITEM, 
		"Name=specs[listingCards][1][search_request_params][user_id]", "Value=", ENDITEM, 
		"Name=specs[listingCards][1][is_mobile]", "Value=false", ENDITEM, 
		"Name=specs[listingCards][1][organic_listings_count]", "Value=12838182", ENDITEM, 
		"Name=specs[listingCards][1][customizable_organic_listing_ids][]", "Value=866367562", ENDITEM, 
		"Name=view_data_event_name", "Value=search_lazy_loaded_cards_specview_rendered", ENDITEM, 
		LAST);
	...
	web_submit_data("chef-check", 
		"Action=https://www.etsy.com/api/v3/ajax/public/chef-check", 
		"Method=POST", 
		...
		"Mode=HTML", 
		ITEMDATA, 
		"Name=_nnc", "Value=3:1707730986:WpCHZbOYjdDCv77Y6L9aBjDzL9o6:bcc03c71f0778740d1e55c864ecd8d5c1d247702143713120b781fcabc1c397e", ENDITEM, 
		"Name=logging_keys", "Value=d89af217da141fad7f792ec5e2733f3556773dd2:1637877329,abd8d4f3cd401344d5aed0c35352da6d519279c2:958950210,1b9b32fa01bccac7b0e36ea00f2c77667dd05f33:1571852170,9fa9310c1480106b3825c7e8c95a7d50a204855b:1154157758", ENDITEM, 
		"Name=display_locs", "Value=w.1-1,w.1-2,w.1-3,w.1-4", ENDITEM, 
		"Name=breakpoint", "Value=xl", ENDITEM, 
		"Name=special_treatments_per_display_loc", "Value=[]", ENDITEM, 
		"Name=referring_listing_id", "Value=null", ENDITEM, 
		"Name=page_guid", "Value=f881efcd980.77657212cd0fcccc8df8.00", ENDITEM, 
		LAST);
	...
	web_custom_request("statsd_3", 
		...
		"Mode=HTML", 
		"EncType=text/plain;charset=UTF-8", 
		"Body={\"stats\":[{\"method\":\"timing\",\"stats\":\"search2.lazy_loaded_listing_cards.replacement\",\"time\":13,\"sampledRate\":0.1},{\"method\":\"timing\",\"stats\":\"async_spec_load.js.listingCards.transfer_size\",\"time\":55738,\"sampledRate\":0.1},{\"method\":\"increment\",\"stats\":\"async_spec_load.js.listingCards.status_code.200\",\"sampledRate\":0.1}],\"_nnc\":\"3:1707730986:WpCHZbOYjdDCv77Y6L9aBjDzL9o6:bcc03c71f0778740d1e55c864ecd8d5c1d247702143713120b781fcabc1c397e\"}", 
		LAST);
	...
	web_url("listing_async_review_variations", 
		"URL=https://www.etsy.com/api/v3/ajax/bespoke/public/neu/specs/listing_async_review_variations?log_performance_metrics=false&specs%5Blisting_async_review_variations%5D%5B%5D=Etsy%5CWeb%5CListingPage%5CReviews%5CVariationsApiSpec&specs%5Blisting_async_review_variations%5D%5B1%5D%5Btransaction_ids%5D%5B%5D=3932598081&specs%5Blisting_async_review_variations%5D%5B1%5D%5Btransaction_ids%5D%5B%5D=3864423796&specs%5Blisting_async_review_variations%5D%5B1%5D%5Btransaction_ids%5D%5B%5D=3803946287&"
		"specs%5Blisting_async_review_variations%5D%5B1%5D%5Btransaction_ids%5D%5B%5D=3867893430&specs%5Blisting_async_review_variations%5D%5B1%5D%5Bshop_id%5D=22962537&specs%5Blisting_async_review_variations%5D%5B1%5D%5Blisting_id%5D=1053942963&specs%5Blisting_async_review_variations%5D%5B1%5D%5Bcategory_path%5D%5B%5D=1179&specs%5Blisting_async_review_variations%5D%5B1%5D%5Bcategory_path%5D%5B%5D=1217&specs%5Blisting_async_review_variations%5D%5B1%5D%5Bcategory_path%5D%5B%5D=1222", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=https://www.etsy.com/in-en/listing/1053942963/flower-necklace-tiny-flower-necklace?click_key=0db306813f98f1d5957e48b05aaa923d78dba80c%3A1053942963&click_sum=b29c9ab1&ref=search2_top_narrowing_intent_modules_etsys_pick-2&pro=1&sts=1", 
